...
namespace DAL
{
    ...
    /// T_VideoRates数据访问类
    /// </summary>
    public partial class T_VideoRatesDAL
    {
        #region 查询
        /// <summary>
        /// 获取实体根据主键
        ...
        {
            return DbHelperByDapper.GetModel<T_VideoRates>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_VideoRates>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_VideoRates>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_VideoRates>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
