...
namespace DAL
{
    ...
    /// T_Comments数据访问类
    /// </summary>
    public partial class T_CommentsDAL
    {
        #region 查询
        /// <summary>
        /// 获取实体根据主键
        ...
        {
            return DbHelperByDapper.GetModel<T_Comments>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Comments>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Comments>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_Comments>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
