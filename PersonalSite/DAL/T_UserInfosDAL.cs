...
namespace DAL
{
    ...
    /// T_UserInfos数据访问类
    /// </summary>
    public partial class T_UserInfosDAL
    {
        #region 查询
        /// <summary>
        /// 获取实体根据主键
        ...
        {
            return DbHelperByDapper.GetModel<T_UserInfos>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_UserInfos>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_UserInfos>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_UserInfos>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
