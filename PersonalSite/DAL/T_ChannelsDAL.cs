...
namespace DAL
{
    ...
    /// T_Channels数据访问类
    /// </summary>
    public partial class T_ChannelsDAL
    {
        #region 查询
        /// <summary>
        /// 获取实体根据主键
        ...
        {
            return DbHelperByDapper.GetModel<T_Channels>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Channels>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Channels>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_Channels>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
