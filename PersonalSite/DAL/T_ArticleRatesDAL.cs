...
namespace DAL
{
    ...
    public partial class T_ArticleRatesDAL
    {
        ...
        {
            return DbHelperByDapper.GetModel<T_ArticleRates>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_ArticleRates>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_ArticleRates>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_ArticleRates>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
