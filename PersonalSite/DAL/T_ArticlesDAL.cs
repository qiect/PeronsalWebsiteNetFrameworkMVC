...
namespace DAL
{
    ...
    public partial class T_ArticlesDAL
    {
        ...
        {
            return DbHelperByDapper.GetModel<T_Articles>(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Articles>(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetList<T_Articles>(conditions,parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return DbHelperByDapper.GetListPages<T_Articles>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
