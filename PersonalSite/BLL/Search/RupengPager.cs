...
namespace PersonSite.Search
{
    public class RupengPager
    {
        ...
        private string GetPageLink(int i,string text)
        {
            ...
            sb.Append("<a class='btn btn-primary btn-sm' href='").Append(url).Append("'>").Append(text).Append("</a>");
            return sb.ToString();
        }
        private void Check()
        {
        ...
        public string Render()
        {
            ...
            {
                sb.Append("<span class='btn btn-primary btn-sm'>首页</span>");
                //如果没有上一页了，则只显示一个上一页的文字，没有超链接
                sb.Append("<span class='btn btn-primary btn-sm'>上一页</span>");
            }
            ...
            for (int i = visibleStart; i <= visibleEnd; i++)
            {
                ...
                {
                    sb.Append("<span class='btn btn-primary btn-sm'>").Append(i).Append("</span>");
                }
                else
                {
            ...
            {
                sb.Append("<span class='btn btn-primary btn-sm'>下一页</span>");
                sb.Append("<span class='btn btn-primary btn-sm'>末页</span>");
            }            
            return sb.ToString();
        }
    }
