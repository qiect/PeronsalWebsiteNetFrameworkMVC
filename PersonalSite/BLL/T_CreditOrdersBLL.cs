...
namespace BLL
{
    ...
    /// T_CreditOrders业务逻辑类
    /// </summary>
    public partial class T_CreditOrdersBLL
    {
        #region 查询
        /// <summary>
        /// 获取实体根据主键
        ...
        {
            return new T_CreditOrdersDAL().GetModel(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return new T_CreditOrdersDAL().GetList(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return new T_CreditOrdersDAL().GetList(conditions, parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return new T_CreditOrdersDAL().GetListPages<T_CreditOrders>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
        ...
        {
            return new T_CreditOrdersDAL().InsertDb(entity);
        }
        /// <summary>
        /// 事务批量插入
        /// </summary>
        ...
        {
            return new T_CreditOrdersDAL().InsertDb(entityList);
        }
        #endregion
        ...
        {
            return new T_CreditOrdersDAL().ModifyDb(entity);
        }
        /// <summary>
        ...
        {
            return new T_CreditOrdersDAL().ModifyDb(entityList);
        }
        #endregion
        ...
        {
            return new T_CreditOrdersDAL().DeleteDb(entity);
        }
        ...
        {
            return new T_CreditOrdersDAL().DeleteDb(id);
        }
        /// <summary>
        /// 条件删除
        /// </summary>
        ...
        {
            return new T_CreditOrdersDAL().DeleteDbList(entity, whereConditions);
        }
        #endregion
