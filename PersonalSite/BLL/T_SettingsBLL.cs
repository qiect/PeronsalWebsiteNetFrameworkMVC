...
namespace BLL
{
    ...
    public partial class T_SettingsBLL
    {
        ...
        {
            return new T_SettingsDAL().GetModel(id);
        }
        /// <summary>
        /// 获取列表根据条件
        /// </summary>
        ...
        {
            return new T_SettingsDAL().GetList(whereConditions);
        }
        /// <summary>
        /// 获取列表根据条件字符串
        /// </summary>
        ...
        {
            return new T_SettingsDAL().GetList(conditions, parameters);
        }
        /// <summary>
        /// 分页查询
        /// </summary>
        ...
        {
            return new T_SettingsDAL().GetListPages<T_Settings>(pageNumber, rowsPerPage, conditions, orderby, parameters);
        }
        #endregion
        ...
        {
            return new T_SettingsDAL().InsertDb(entity);
        }
        /// <summary>
        /// 事务批量插入
        /// </summary>
        ...
        {
            return new T_SettingsDAL().InsertDb(entityList);
        }
        #endregion
        ...
        {
            return new T_SettingsDAL().ModifyDb(entity);
        }
        /// <summary>
        ...
        {
            return new T_SettingsDAL().ModifyDb(entityList);
        }
        #endregion
        ...
        {
            return new T_SettingsDAL().DeleteDb(entity);
        }
        ...
        {
            return new T_SettingsDAL().DeleteDb(id);
        }
        /// <summary>
        /// 条件删除
        /// </summary>
        ...
        {
            return new T_SettingsDAL().DeleteDbList(entity, whereConditions);
        }
        #endregion
